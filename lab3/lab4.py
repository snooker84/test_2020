...
screen = pygame.display.set_mode((constantsmodule.WINDOW_WIDTH, constantsmodule.WINDOW_HEIGHT))
...
while not finished:
    clock.tick(constantsmodule.FPS)
    draw_hare(screen, constantsmodule.x, constantsmodule.y, constantsmodule.WIDTH, constantsmodule.HEIGHT,
              constantsmodule.COLOR)
    pygame.display.update()
